LANGUAGE_NAME := tree-sitter-qsharp
HOMEPAGE_URL := https://github.com/bezpechno/tree-sitter-qsharp
VERSION := 0.1.2
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/qsharp '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/qsharp
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/qsharp
